  ...
  useEffect(() => {
    ...
    const fetchProgress = async () => {
      ...
      if (data.length === 0) {
        ...
        setChoice(data[0].data?.step2?.choice || "");
      }
      setLoading(false);
    };
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-r from-[#4D4D4D] to-[#010101] text-white p-4">
      ...
      <div className="flex gap-4 sm:gap-6 mb-6 justify-center flex-wrap">
        <div
          ...
          className={`cursor-pointer p-4 bg-[#6D6D6D] rounded-lg ${
            choice === "Nike Orange" ? "border-4 border-green-500" : ""
          } w-[150px] sm:w-[180px] flex flex-col items-center`}
        >
        ...
        <div
          ...
          className={`cursor-pointer p-4 bg-[#6D6D6D] rounded-lg ${
            choice === "Nike Black" ? "border-4 border-green-500" : ""
          } w-[150px] sm:w-[180px] flex flex-col items-center`}
        >
